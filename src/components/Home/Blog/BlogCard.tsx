    ...
    return (
        <div className="bg-indigo-950 rounded-md overflow-hidden">
            <Image
                ...
                height={300}
                alt={title}
                className="w-full h-[250px] objext-cover"
            />
            <div className="p-6">
                <p className="rounded-sm px-6 py-1.5 bg-rose-500 text-white w-fit ">
                    News
                </p>
                <h1 className="sm:text-lg text-base cursor-pointer hover:text-gray-100 hover:underline transition-all durition-200 mt-6 mb-2 text-gray-200 leading-[1.6rem] font-bold   ">
                    {title}
                </h1>

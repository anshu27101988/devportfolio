    ...
    return (
        <div className="pt-16 pb-16 bg-[#050709]">
            ...
            <div className="w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mt-20">
                ...
                >
                    <h1 className="text-bg text-[26px] sm:text-3xl md:text-4xl lg:5xl font-bold text-gray-200">
                        {aboutInfo.title}
                    </h1>
                    {/* Description */}
                    ...
                    <div className="mt-8">
                        <div className="flex items-center space-x-2 mb-6">
                            ...
                            <p className="text-sm sm:text-base md:text-lg font--boldb text-gray-300">
